...
class Additional extends React.Component {
  ...
  render() {
    return (
      <section id={this.props.category} className={styles.work}>
        <div className={styles.blue}></div>
        <div className={styles.container}>
          <div className={styles.workHeader}>
            {this.props.title} <div className="hr float_right"></div>
          </div>
          <p className={"white clearFix float_right " + styles.workDescr}>
